...
export default function ForgotPasswordScreen() {
    ...
    return (
        ...
        >
            <ScrollView contentContainerStyle={tailwind("flex-grow")} keyboardShouldPersistTaps="handled">
                ...
                <Layout style={tailwind('flex-1 items-center')}>
                    ...
                    <View style={tailwind('w-full px-6 mt-20p')}>
                        ...
                        <Input
                            ...
                            style={tailwind('mb-4')}
                        />
                        <SendButton handleSendOTP={handleSendOTP} />
                        <OTPInput ref={otpRef} style={tailwind("mt-5p")} length={6} />

                        <Button style={tailwind('mt-4')} status="info" onPress={handleResetPassword}>
                            Đặt lại mật khẩu
                        </Button>
                    </View>
...
const SendButton: React.FC<{ handleSendOTP: () => boolean }> = React.memo(({ handleSendOTP }) => {

...
import 'package:flutter_application/models/register_request.dart';
          ...
          MaterialPageRoute(
            builder:
                (context) => OtpVerificationPage(
                  ...
                  password:
                      _passwordController
                          .text, // Pass password for final registration step
                ...
                children: <Widget>[
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      return (value == null || value.length < 6)
                          ...
                          : null;
                    }, // Vietnamese: Password needs at least 6 characters
                  ),
                  SizedBox(height: 15),
                  TextFormField(
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Text(
                        'Đã có tài khoản?',
                      ), // Vietnamese: Already have an account?
                      TextButton(
                        onPressed:
                            _isLoading
                                ? null

...
export interface CheckFavoritePodcastResponse extends CheckFavoriteStatusResponse {
    podcastId: number;
}

export interface ToggleFavoritePodcastResponse extends CheckFavoritePodcastResponse { }

export interface CheckFavoriteElementResponse extends CheckFavoriteStatusResponse {
    elementId: number;
}
